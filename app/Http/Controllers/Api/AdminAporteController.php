...
class AdminAporteController extends Controller
{
    ...
    public function aprobar(DecisionAporteRequest $request, Aporte $aporte, ColaboracionService $service): JsonResponse { return $this->decidir($request, $aporte, $service, true); }
    public function rechazar(DecisionAporteRequest $request, Aporte $aporte, ColaboracionService $service): JsonResponse { return $this->decidir($request, $aporte, $service, false); }
