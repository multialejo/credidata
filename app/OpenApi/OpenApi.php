...
class OpenApi
{
    ...
    /**
     * @OA\Post(path="/api/v1/colaboradores/datos", tags={"Colaboradores"}, summary="Registra un aporte", description="Requiere API Key Bearer activa y scope colaboradores:aportes (o wildcard aplicable), además de colaborador cliente activo. Un campo sin valor se aprueba automáticamente; una reescritura queda pendiente.", security={{"ApiKeyBearer":{}}}, @OA\RequestBody(required=true, @OA\JsonContent(required={"identificador","tipo_dato","valor"}, @OA\Property(property="identificador", type="string", example="1713175071"), @OA\Property(property="tipo_dato", type="string", enum={"telefono","email","direccion"}), @OA\Property(property="valor", type="string"))), @OA\Response(response=201, description="Aporte aprobado o pendiente"), @OA\Response(response=403, description="Colaborador inactivo"), @OA\Response(response=422, description="Datos inválidos o destino inexistente"))
     */
