...
{
    /**
     * @OA\Post(path="/api/v1/colaboradores/registro", tags={"Colaboradores"}, summary="Activa un colaborador", description="Requiere API Key Bearer activa y scope colaboradores:registro (o wildcard aplicable).", security={{"ApiKeyBearer":{}}}, @OA\RequestBody(required=true, @OA\JsonContent(required={"acepta_terminos"}, @OA\Property(property="acepta_terminos", type="boolean", example=true))), @OA\Response(response=201, description="Perfil creado"), @OA\Response(response=200, description="Perfil ya activo"), @OA\Response(response=403, description="No es cliente"), @OA\Response(response=422, description="Términos no aceptados"))
     */
    public function activarColaborador(): void {}

    /**
     * @OA\Post(path="/api/v1/colaboradores/datos", tags={"Colaboradores"}, summary="Registra un aporte", description="Requiere API Key Bearer activa y scope colaboradores:aportes (o wildcard aplicable), además de colaborador cliente activo. El teléfono debe tener exactamente 10 dígitos y comenzar con 0. Los reenvíos idénticos pendientes devuelven la solicitud existente; los datos ya publicados se rechazan. Aplican límites diarios configurables por identificador y colaborador. Un campo sin valor se aprueba automáticamente; una reescritura queda pendiente.", security={{"ApiKeyBearer":{}}}, @OA\RequestBody(required=true, @OA\JsonContent(required={"identificador","tipo_dato","valor"}, @OA\Property(property="identificador", type="string", example="1713175071"), @OA\Property(property="tipo_dato", type="string", enum={"telefono","email","direccion"}), @OA\Property(property="valor", type="string"))), @OA\Response(response=201, description="Aporte aprobado o pendiente"), @OA\Response(response=403, description="Colaborador inactivo"), @OA\Response(response=422, description="Datos inválidos o destino inexistente"))
     */
    public function registrarAporte(): void {}

    /** @OA\Get(path="/api/v1/colaboradores/aportes/{aporte}", tags={"Colaboradores"}, summary="Consulta un aporte propio", description="Requiere API Key Bearer activa y scope colaboradores:aportes (o wildcard aplicable).", security={{"ApiKeyBearer":{}}}, @OA\Parameter(name="aporte", in="path", required=true, @OA\Schema(type="integer")), @OA\Response(response=200, description="Aporte"), @OA\Response(response=403, description="Aporte de otro colaborador"), @OA\Response(response=404, description="No existe")) */
