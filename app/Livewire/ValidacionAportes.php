...
class ValidacionAportes extends Component
{
    ...
    public function decidir(int $id, bool $aprobar, ColaboracionService $service): void
    {
        ...
        $this->detalleId = null; $this->comentario = ''; $this->resetPage();
    }
    public function render() { return view('livewire.validacion-aportes', ['aportes' => Aporte::with('colaborador.usuario')->where('estado', 'pendiente')->latest('fecha')->paginate(15)]); }
}
